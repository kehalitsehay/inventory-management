                ...
                <div class="col-sm-4 py-1">
                  ...
                  <table width="100%">
                    <tr>
                      ...
                      <td class="text-right">ETB <?php echo number_format($sub, 2, '.', ''); ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">VAT</td>
                      <td class="text-right">ETB <?php echo number_format($less, 2, '.', ''); ?></td>
                      </tr>
                    
                    <tr>
                      <td class="font-weight-bold">Total</td>
                      <td class="font-weight-bold text-right text-primary">ETB <?php echo number_format($net, 2, '.', ''); ?></td>
                    </tr>
                  </table>
                </div>
