...
$result3 = mysqli_query($db, $sql5) or die ("Bad SQL: $sql3");
$customer = "<select class='form-control' name='customer' required>
...
$customer .= "</select>";
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Add Sales</h4>
            </div>
            <a href="#" type="button" class="btn btn-primary bg-gradient-primary">Back</a>
            <div class="card-body">
                        ...
                        <input type="hidden" name="role" value="<?php echo $_SESSION['JOB_TITLE']; ?>">
                            ...
                            <select class="form-select col-md-12 mt-2 p-2" class = "form-control" name = "status" aria-label="Default select example" required>
                                <option selected>Sales Method</option>
