...
<form class="row g-3" method="POST" action="bank_deposit_transac_sales.php?action=add" role="form">
  <div class="col-md-3">
  ...
  <div class="col-md-3">
    ...
    <input type="number" class="form-control" name="amount" for="amount" step="0.01" min="0" required>
  </div>
  <div class="col-md-3">
