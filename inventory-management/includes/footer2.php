      ...
      <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; ABC Hypermarket. All rights Reserved.</div>
                            <div>
                                Developed by <a href="https://kehalitsportfolio.netlify.app" target="_blank" class="portfolio">Ultra Power</a>
                                &middot;
                            </div>
                        </div>
                    </div>
